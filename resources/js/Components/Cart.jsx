...
const Cart = () => {
    return (
        <section className="bg-white px-8 antialiased dark:bg-gray-900 rounded-lg ">
            <div className="rounded-lg">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Your Cart</h2>

                <div className="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8 rounded-lg">
                ...
                <div className="mx-auto mt-6 max-w-4xl flex-1 space-y-6 lg:mt-0 lg:w-full rounded-lg">
